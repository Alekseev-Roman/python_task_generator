...
CREATE TABLE test_case (test_case_id serial PRIMARY KEY, task_id serial REFERENCES task (task_id), use_as_example boolean, test_code text, stdin text, expected text);

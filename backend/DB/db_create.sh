...
CREATE TABLE coderunner_task (task_id serial REFERENCES task (task_id) PRIMARY KEY, coderunner_type varchar(64), template text, template_params varchar(64), answer_preload varchar(128));
